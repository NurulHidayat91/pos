<html moznomargininboxes mozdisallowselectionprint>
    <head>
        <title>PT Dragon Pack - Print Nota</title>
        <style type="text/css">
                        ...
                        foreach ($sale_detail as $key => $value) {?>
                            <tr>
                                ...
                                <td style="text-align: right; width:60px">
                                     <?=indo_currency(($value->detail_price - $value->discount_item) * $value->qty)?>
                                </td>
                            </tr>
                   ...
                   <?php
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="border-top:1px dashed; text-align:right; padding:5px 0"><?=$sale->final_price?></td>
                        </tr>

                        <tr>
                            <td colspan="2"></td>
                            <td style="border-top:1px; text-align:right; padding-top:5px">Cash</td>
                            <td style="border-top:1px; text-align:right; padding-top:5px"><?=$sale->cash?></td>
                        </tr>
