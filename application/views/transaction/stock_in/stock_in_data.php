            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?= site_url('stock/in/add') ?>" class="btn btn-primary float-right btn-sm"><i class="fa fa-category-plus"></i>Create</a>
                                ...
                                foreach ($row as $key => $value) { ?>
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center" width=120px>
                                            ...
                                            <a onclick="return confirm('Apakah anda yakin??')" href="<?= site_url('stock/in/delete/' . $value->stock_id . '/' . $value->item_id) ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>
