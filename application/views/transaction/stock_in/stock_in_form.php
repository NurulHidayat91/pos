        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="<?= site_url('stock/in') ?>" class="btn btn-primary float-right btn-sm"><i class="fa fa-undo"></i>Back</a>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= site_url('stock/proses') ?>">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="in_add" class="btn btn-primary btn-flat"><i class="fa fa-paper-plane"> Simpan</i></button>
