...
class M_item extends CI_Model
{
    ...
    var $column_search = array('barcode', 'p_item.name', 'price', 'p_category.name'); //set column field database for datatable searchable
    ...
    function get($id = null)
    {
        ...
        $this->db->from('p_item');
        $this->db->join('p_category', 'p_category.category_id = p_item.category_id', 'left');
        $this->db->join('p_unit', 'p_unit.unit_id = p_item.unit_id', 'left');
